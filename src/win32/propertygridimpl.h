...
#define WC_PROPERTYGRIDCTLA  "PropGridCtl"
#define WC_PROPERTYGRIDCTLW  L"PropGridCtl"

#ifdef UNICODE
#define WC_PROPERTYGRIDCTL  WC_PROPERTYGRIDCTLW
#else
#define WC_PROPERTYGRIDCTL  WC_PROPERTYGRIDCTLA
#endif
...
#define PIT_CHECKCOMBO  3   ///< Property item type: Checked dropdown //DWM 2.2:Added
#define PIT_STATIC      4   ///< Property item type: Not editable text
#define PIT_COLOR       5   ///< Property item type: Color
#define PIT_FONT        6   ///< Property item type: Font
#define PIT_FILE        7   ///< Property item type: File select dialog
#define PIT_FOLDER      8   ///< Property item type: Folder select dialog
#define PIT_CHECK       9   ///< Property item type: BOOL
#define PIT_IP          10  ///< Property item type: IP Address
#define PIT_DATE        11  ///< Property item type: Date
#define PIT_TIME        12  ///< Property item type: Time
#define PIT_DATETIME    13  ///< Property item type: Date & Time
...
#define PropGrid_GetItemData(hwndCtl,index) \
         ((LPPROPGRIDITEM)(DWORD_PTR)SendMessage((hwndCtl),LB_GETITEMDATA,(WPARAM)(int)(index),0))
...
#define PropGrid_GetItemRect(hwndCtl,index,lprc) \
...
///
/// @returns No return value.
#define PropGrid_SetHorizontalExtent(hwndCtl,cxExtent) \
         ((void)SendMessage((hwndCtl),LB_SETHORIZONTALEXTENT,(WPARAM)(int)(cxExtent),0))
...
///
/// @returns If an error occurs, the return value is LB_ERR.
#define PropGrid_SetItemData(hwndCtl,index,data) \
...
///
/// @returns No return value.
#define PropGrid_ExpandCatalogs(hwndCtl, lpszzCatalogs) \
         ((void)SendMessage((hwndCtl),PG_EXPANDCATALOGS,(WPARAM)0,(LPARAM)(lpszzCatalogs)))
...
///
/// @returns No return value.
#define PropGrid_CollapseCatalogs(hwndCtl, lpszzCatalogs) \
         ((void)SendMessage((hwndCtl),PG_COLLAPSECATALOGS,(WPARAM)0,(LPARAM)(lpszzCatalogs)))
...
///
/// @returns No return value.
#define PropGrid_ShowPropertyDescriptions(hwndCtl,fShow) \
         ((void)SendMessage((hwndCtl),PG_SHOWPROPERTYDESC,(WPARAM)(fShow),(LPARAM)0L))
...
#define PropGrid_ItemInit(pgi) \
    ...
    pgi.lpCurValue = 0, pgi.lpUserData = NULL, pgi.iItemType = 0)
